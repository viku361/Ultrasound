...
sound_Big = 2500*makeDisc(X,Y,X/2,5*Y/8,X/4);
sound_Big(sound_Big==0)=1500;
Nx=X/2;
Ny=Y/2;
% sound_crop= sound_Big(X/2-Nx/2+1:X/2+Nx/2,5*Y/8-Ny/2+1:5*Y/8+Ny/2);
sound_crop= sound_Big(X/2-Nx/2+1:X/2+Nx/2,3*Y/8-Ny/2+1:3*Y/8+Ny/2);
dx=50e-6;
dy=50e-6;
kgrid=kWaveGrid(Nx,dx,Ny,dy);
density_Big = 600*makeDisc(X,Y,X/2,5*Y/8,128);
density_Big(density_Big==0)=1000;
% density_crop= density_Big(X/2-Nx/2+1:X/2+Nx/2,5*Y/8-Ny/2+1:5*Y/8+Ny/2);
density_crop= density_Big(X/2-Nx/2+1:X/2+Nx/2,3*Y/8-Ny/2+1:3*Y/8+Ny/2);
